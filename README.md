...
* For example, a memory_profiler has been used to run against the CSV outer block in the `matcher_service`'s `run()` method, while using the `input3.csv` file with 20,001 records.   And here is the result:
